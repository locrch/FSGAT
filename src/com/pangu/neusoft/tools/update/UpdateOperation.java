...
public class UpdateOperation {
	...
	public void checkUpdate(boolean show){
		try {
			localVersion = getVersionName();
			CheckVersionTask cv = new CheckVersionTask(show);
			new Thread(cv).start();
	...
	Handler handler = new Handler(){  
	    ...
	    public void handleMessage(Message msg) {  
	        ...
	        case DOWN_ERROR:  
	            //下载apk失败  
	            Toast.makeText(activity.getApplicationContext(), "下载新版本失败", Toast.LENGTH_SHORT).show();  
